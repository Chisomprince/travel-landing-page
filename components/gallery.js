...
export default function Gallery() {
  return (
    <div className="mb-16 lg:mb-52 bg-gradient-to-b from-yellow-100 to-white">
      <div className="lg:grid lg:grid-cols-3 gap-6 space-y-8  lg:h-screen px-4 lg:px-16">
        ...
        <div className="lg:flex lg:flex-col-reverse">
          <div className="h-full ">
            <img
              src="https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=480&q=80"
              alt=""
              className="object-cover h-full "
            />
          </div>
